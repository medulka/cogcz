...
src1 = "/Users/hanamedova/Documents/COG/week30/datafreeze-2021-07-30_12_weeks_good.pangolin-3.1.8-pangoLEARN-2021-07-28.csv"
src2 = "/Users/hanamedova/Documents/COG/week30/datafreeze-2021-07-30_12_weeks_good.tsv"
...
# def set_bottom(data4, lineage_index):
#     lst = []
#     lst2 = []
#     values = list(data4.values())
#     for i in range(len(unique_weeks)):
#         for j in range(lineage_index):
#             lst.append(values[i][j])
#         a = sum(lst)
#         lst2.append(a)
#     return lst2

# b = set_bottom(data4,1)
...
# for lineage_index,lineage in enumerate(unique_lineages):
#     sns.barplot(
#         x=unique_weeks, 
#         y= data4[lineage], 
#         data=data4, 
#         label=lineage, 
#         color=add_color_code(lineage),
#         bottom = set_bottom(data4, lineage)
