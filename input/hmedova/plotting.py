...
# Load the dataset
# get the data total and lineages
...
labels = unique_lineges(src1,src2)
['B.1.1.7', 'B.1.617.2', 'P.1', 'C.36.3', 'B.1.351', 'B.1.1.354']
# def split_lineages(df, lineages):
#     for lin in range(len(lineages)):
#        return df.loc[df["lineage"]== lin].sort_values("week_number")
...
#categoricka data
# source_columns = data_lineage2.columns
